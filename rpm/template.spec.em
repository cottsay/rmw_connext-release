...
Provides = [p for p in Provides if p != 'ros-eloquent-rmw-implementation-packages(member)']
Supplements = [p for p in Supplements if p != 'ros-eloquent-rmw-implementation-packages(all)']
}@
%bcond_without tests
